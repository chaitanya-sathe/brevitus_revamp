...
export default function Events() {
  ...
  useEffect(() => { api.get("/public/events").then(safeList(setItems)).catch(() => {}); }, []);
  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        {list.length === 0 && <div className="text-center text-slate-500 py-16">No events posted yet. Check back soon.</div>}
