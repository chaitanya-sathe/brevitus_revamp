...
export default function Internships() {
  ...
  useEffect(() => { api.get("/public/internships").then(safeList(setItems)).catch(() => {}); }, []);
  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        {list.length === 0 && <div className="text-center text-slate-500 py-16">No open internships right now. Follow us to be notified.</div>}
